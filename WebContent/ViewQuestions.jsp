	...
	<div class="container" style="margin-top: 70px; margin-left: 250px; background-color:lightgrey;width:60%; overflow-x:auto;">
					...
					<div class="form">
						<form action="ViewQuestions.jsp" method="post">
							<table>
								<tr>
									...
									<td><th>MARKS</th></td>
									<td><select class="form-control" name="marks"
										style="width: 100px; height: 30px">
											<option>Select</option>
									...
									<td><th>UNIT</th></td>
									<td><select class="form-control" name="unit" style="width: 100px; height: 30px">
											<option>Select</option>
											<option value="1">1</option>
											<option value="2">2</option>
											<option value="3">3</option>
								...
								<tr>
									...
									<td><input type="submit" value="Show"
										style="margin-left: 200px" class="btn btn-light"></td>
									<td></td>
								</tr>
							</table>
						...
						<%
							...
							System.out.println("Marks..." + marks + "unit" + unit);
							Connection con = ConnectionProvider.getConnection();
							String qur1 = "select *from question where marks='" + marks
									+ "' and unit='" + unit + "' and subject='"+subject+"'";
