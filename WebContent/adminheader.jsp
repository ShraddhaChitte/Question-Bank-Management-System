      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
  	    ...
  	    <li><a href="AddQuestions.jsp">Add Questions</a></li>
   	    <li><a href="AdminViewQuestions.jsp">View Question</a></li> 	    
    	<li><a href="AdminViewStudent.jsp">View Students</a></li> 
    	<li><a href="AdminViewFeedback.jsp">View Feedbacks</a></li>   
