...
<body style="background-image: url('./img/tent.jpg');">
	...
	<div style="margin-top: 70px; margin-left: 100px; background-color:lightgrey;width:80%; overflow-x:auto;" >
...
<thead class="thead-light">
							...
							<td><button type="submit"
									onclick="location.href='DeleteItem?id=<%=id%>'" class="btn btn-warning">Delete</button>
							
														<td><button type="submit"
									onclick="location.href='UpdateQuestion.jsp?id=<%=id%>'" class="btn btn-info">Update</button>
